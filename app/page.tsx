  ...
  return (
    <div className="flex-col items-center justify-center w-full  h-full">
      ...
      <div className="m-12 flex justify-center gap-5 flex-wrap">
        ...
        <Link href={'/students/new'} className="p-4 bg-orange-700 dark:bg-orange-900 rounded text-gray-200 dark:text-gray-300 hover:-translate-y-1 transition-transform">Register Students</Link>
        <Link href={'/students'} className="p-4 bg-orange-700 dark:bg-orange-900 rounded text-gray-200 dark:text-gray-300 hover:-translate-y-1 transition-transform">All Students</Link>
